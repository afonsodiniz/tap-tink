...
class TinkAuthenticator(OAuthAuthenticator, metaclass=SingletonMeta):
    """Authenticator class for Tink."""
    ...
    @classmethod
    def create_for_stream(cls, stream) -> TinkAuthenticator:  # noqa: ANN001
